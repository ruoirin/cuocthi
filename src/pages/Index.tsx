...
// --- DỮ LIỆU CUỘC THI: CẬP NHẬT NGÀY 31/12/2025 ---
const competitionsData = [
  ...
  },
  {
    ...
    details: {
      ...
      schedule: [
        { phase: "Vòng 8 Sơ khảo", time: "30/12/2025 - 03/01/2026 (Đang thi)" },
      ...
      highlight: "Lịch thi Vòng 8: Miền Bắc 30-31/12, Miền Trung & Nam 01-02/01, Toàn quốc 03/01/2026.",
  ...
  },
  {
    ...
    details: {
      target: "Học sinh từ Mầm non - THPT",
      schedule: [
        { phase: "Hạn đăng ký Vòng QG", time: "Đã hết hạn (17/12/2025)" },
  ...
  },
  {
    ...
    status: "Vòng Trường đến 01/2026",
    statusType: "active",
    color: "blue",
    icon: "star",
